...
import { UtensilsCrossed, Bike, Lock, Mail, ArrowLeft } from 'lucide-react';
        ...
        <div className="rounded-2xl border bg-card p-8 shadow-lg animate-slide-up">
          <div className="mb-6 text-center">
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Sign in to view available deliveries
            </p>
          </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  placeholder="ramesh@delivery.com"
          ...
          <div className="mt-4 rounded-lg bg-accent/50 p-3 text-center text-xs text-muted-foreground">
            Demo credentials: ramesh@delivery.com / any password
          </div>
        </div>
